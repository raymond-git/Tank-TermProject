...
// between the two classes so that the logic for e.g. moveForward, etc. are not duplicated.
    ...
    public abstract void ClickPressUp();

    public abstract void ClickPressDown();

    public abstract void ClickPressRight();

    public abstract void ClickPressLeft();

    public abstract void ClickPressEscape();
}