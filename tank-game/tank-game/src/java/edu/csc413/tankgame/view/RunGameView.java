...
public class RunGameView extends JPanel {
    ...
    public static final double AI_TANK_2_INITIAL_X = 400.0;
    public static final double AI_TANK_2_INITIAL_Y = 100.0;
    ...
    public static final double SHELL_INITIAL_X = 700.0;
    public static final double SHELL_INITIAL_Y = 500.0;
    public static final double SHELL_INITIAL_ANGLE = Math.toRadians(180.0);

   // public static final String WALLS_SETUP_FILE = "wall-1.png";

    public static final String WALL_IMAGE_FILE = "wall-2.png";
    public static final double WALL_IMAGE_INITIAL_X = 100.0;
    public static final double WALL_IMAGE_INITIAL_Y = 200.0;
    public static final double WALL_IMAGE_INITIAL_ANGLE = Math.toRadians(0.0);
...
//
//    public static final String SHELL_IMAGE_FILE = "shell.png";
//    public static final String WALLS_IMAGE_FILE = "wall-9.png";
//    public static final String WALLS_IMAGE_FILEs = "wall-8.png";
//    public static final double WALL_IMAGE_INITIAL_X = 100.0;
//    public static final double WALL_IMAGE_INITIAL_Y = 150.0;
//    public static final double WALL_IMAGE_INITIAL_ANGLE = Math.toRadians(0.0);
//
//    private static final String SHELL_EXPLOSION_FILE_PREFIX = "shell-explosion-";
//    private static final String SHELL_EXPLOSION_FILE_SUFFIX = ".png";
...
//
//    public void addDrawableEntity(
//            String wall_ID, String id, String entityImageFile, double initialX, double initialY, double initialAngle) {
//        DrawableEntity drawableEntity = new DrawableEntity(entityImageFile);
//        drawableEntity.setLocationAndAngle(initialX, initialY, initialAngle);
//        drawableEntitiesById.put(id, drawableEntity);
//    }
